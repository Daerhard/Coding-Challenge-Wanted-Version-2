...
class CompleteImageTest {
	...
	void testGetBackgroundImage() {
		...
		URL testUrlBackgroundImage  = ClassLoader.getSystemResource("JUnitTestImage.jpg");
		//Create Instance for the test
		CompleteImage completeImage = new CompleteImage(233, 400, BufferedImage.TYPE_INT_RGB, testUrlBackgroundImage.toString());
